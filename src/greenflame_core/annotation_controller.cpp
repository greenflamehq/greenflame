...
// Generated by greedy-next-available algorithm on log curve 5*(288/5)^((step-1)/49).
static constexpr std::array<int32_t, 50> kTextSizePtTable = {{
...
void AnnotationController::Begin_text_draft(PointPx origin) {
    ...
    TextAnnotationBaseStyle const base_style{
        freehand_style_.color, Normalize_text_font_choice(text_current_font_),
        kTextSizePtTable[static_cast<size_t>(text_size_step_ - 1)]};
