...
### GF-MAN-INSTALL-001 - User-Only Installer Flow

- Priority: `P0`
- Run on: `ENV-C`
- Steps:
  1. Build or download `greenflame-<version>-win-x64.exe`.
  2. Run the installer.
...
- Priority: `P1`
- Run on: `ENV-C` with administrator approval available.
- Steps:
  1. Run `greenflame-<version>-win-x64.exe`.
